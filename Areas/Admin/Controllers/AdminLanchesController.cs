...
namespace VendaLanches.Areas.Admin.Controllers
{
    ...
    public class AdminLanchesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LancheId,Nome,DescricaoCurta,DescricaoLonga,Preco,ImagemURL,ImagemThumbnailURL,LanchePreferido,Estoque,CategoriaId")] Lanche lanche)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LancheId,Nome,DescricaoCurta,DescricaoLonga,Preco,ImagemURL,ImagemThumbnailURL,LanchePreferido,Estoque,CategoriaId")] Lanche lanche)
        {
